...
AR.IMAGEN_ARTICULO AS imagen,AR.DESCRIPCION_ARTICULO as descripcion FROM  ARTICULOS AR  WHERE AR.ID_CATEGORIA_ARTICULO =idcategori;
...
se.DESCRIPCION_SERVICIO as descripcion,se.IMAGEN_SERVICIO as imagen from  SERVICIOS se
